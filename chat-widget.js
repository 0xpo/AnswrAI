(function() {
    const agentId = 'YOUR_AGENT_ID'; // Remplacez par l'ID réel de l'agent
    const chatEndpoint = 'https://yourdomain.com/api/chat'; // Remplacez par votre domaine et endpoint API
